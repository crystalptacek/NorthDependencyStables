...
ggsave("NDepStables_Figure1Dim1Dim2_2018.png", p1, width=10, height=7.5, dpi=300)
...
#save the plot for website chronology page/presentations
ggsave("NDepStables_Dim1BLUEMCD_2018.png", p3, width=10, height=7.5, dpi=300)
...
p5a
ggsave("NDepStables_Histogram_2018.png", p5, width=10, height=7.5, dpi=300)
